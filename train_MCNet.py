...
parser.add_argument('--model_type', type=str, default='mcnet3d_v1', help='model_type')
parser.add_argument('--model_name', type=str, default='MCNet', help='model_name')
parser.add_argument('--max_iteration', type=int, default=12000, help='maximum iteration to train')
...
if __name__ == "__main__":
    ...
    model = net_factory(net_type=args.model_type, in_chns=1, class_num=num_classes, mode="train")
    if args.dataset_name == "LA":
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            for idx in range(num_outputs):
                ...
                y_all = outputs[idx]
                y_prob_all = F.softmax(y_all, dim=1)  # (4, 2 ,W, H, D)
