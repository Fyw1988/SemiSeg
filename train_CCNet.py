...
snapshot_path = args.root_path + "model/{}_{}/{}".format(args.dataset_name, args.labelnum, args.model_name)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num >= max_iterations:
                ...
                break
        if iter_num >= max_iterations:
            # net = net_factory(net_type=args.model_type, in_chns=1, class_num=num_classes, mode="train")
            iterator.close()
            break
    writer.close()